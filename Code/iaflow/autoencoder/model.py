"""
Direct Conv1D and Conv2D autoencoders for IA surfaces.
"""
...
class _DenseBlock(nn.Sequential):
    ...
    def __init__(
        ...
        Arguments:
            ...
            config (object):
                Checked direct-AE architecture configuration.
        """
...
class Conv1dAutoEncoder(AutoEncoder):
    ...
    def __init__(self, config: object, input_shape: tuple[int, int]) -> None:
        ...
        self.encoder_convolution, self.encoder_lengths = _build_conv1d_encoder(
            config,
            input_channels,
            input_length,
        )
        ...
        self.decoder_convolution = _build_conv1d_decoder(
            config,
            input_channels,
...
class Conv2dAutoEncoder(AutoEncoder):
    ...
    def __init__(self, config: object, input_shape: tuple[int, int]) -> None:
        ...
        """
        super().__init__(config, input_shape)
        self.encoder_convolution, self.encoder_sizes = _build_conv2d_encoder(
            config,
            self.input_shape,
        )
        ...
        self.decoder_convolution = _build_conv2d_decoder(
            config,
            self.encoder_sizes,
        )
        self.encoded_shape = (
...
def build_autoencoder(
    ...
    """
    Construct the configured direct surface autoencoder.
