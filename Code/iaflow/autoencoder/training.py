...
def _build_reconstruction_loss(
    name: str,
) -> nn.Module:
    """
    Construct a direct-AE reconstruction loss from its configured name.
...
def fit_autoencoder(
    ...
    *,
    ...
    loss_function = _build_reconstruction_loss(config.training.loss)
